...
You must provide:
- A TL;DR summary: 2-3 sentences capturing the video's main point or key takeaway. Put this in the "tldr" field.
...
- 5-10 key terms: important vocabulary, jargon, concepts, or proper nouns that appear in the video. For each term, provide a brief definition in the context of THIS video. Put these in the "keyTerms" array as {term, definition} pairs.
...
{
  "tldr": "2-3 sentence summary of the video's main point",
  "chapters": [
  ...
  "keyTerms": [
    {"term": "Term name", "definition": "Brief definition in context of this video"}
  ]
}
